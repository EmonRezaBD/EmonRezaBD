...
- **PhD Research** — EEG-based studies on cognitive effort and dark-pattern UI design (Advisor: [Dr. Reza Anaraky](https://www.lsu.edu/eng/cse/people/faculty/anaraky.php))
...
- **Applied AI** — LLM-based UI usability analysis, wafer defect inspection, virtual metrology
...
**Specializations** &nbsp; MFC • Win32 • DLL • WPF • Multi-threading • LLMs • LangChain
